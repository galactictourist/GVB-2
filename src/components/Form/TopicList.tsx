...
export function TopicList() {
  ...
  const [selectedTopic, selectedTopicSetter] = useState(null)

  const [topics, topicsSetter] = useState<TopicEntity[]>([])

  const fetch = async () => {
    const countries = await givabitApi.getTopics()
    topicsSetter(countries.data)
  }
